...
export default function Contact() {
  ...
  <div class="container px-5 py-24 mx-auto" onSubmit={handleSubmit}>
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Contact Us</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">In need of assistance do not hesitate.</p>
    </div>
      ...
      <div class="flex flex-wrap -m-2">
        <div class="p-2 w-1/2">
          <div class="relative">
            ...
            <input type="text" id="name" name="name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-indigo-500">info@pixelsurgedesigners.com</a>
          <p class="leading-normal my-5">Pixel Surge Designers
