    ...
    return (
        <>
          <div className="mt-40 mb-20 text-cyan-50">
            <div className=" flex justify-center  "><h1 className=" bg-clip-text text-transparent  bg-gradient-to-r from-green-400 to-purple-500 text-3xl underline text-bold">About us</h1></div>
